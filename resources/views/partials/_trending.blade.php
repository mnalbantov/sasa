<div class="section trending-ads">
    <div class="section-title tab-manu">
        ...
        <ul class="nav nav-tabs" role="tablist">
            <li role="presentation" class="active"><a href="#recent-ads" data-toggle="tab" aria-expanded="true">Recent Ads</a></li>
            <li role="presentation" class=""><a href="#popular" data-toggle="tab" aria-expanded="false">Popular Ads</a></li>
            <li role="presentation" class=""><a href="#hot-ads" data-toggle="tab" aria-expanded="false">Hot Ads</a></li>
        </ul>
    </div>
    ...
    <div class="tab-content">
        <!-- tab-pane -->
        <div role="tabpanel" class="tab-pane fade active in" id="recent-ads">
            <!-- ad-item -->
            <div class="ad-item row">
                ...
                <div class="item-image-box col-sm-3">
                    <div class="item-image">
                        ...
                        <a href="#" class="verified" data-toggle="tooltip" data-placement="left" title="" data-original-title="Verified"><i class="fa fa-check-square-o"></i></a>
                    </div><!-- item-image -->
                </div>
                ...
                <div class="item-info col-sm-9">
                    ...
                    <div class="ad-meta">
                        ...
                        <div class="user-option pull-right">
                            ...
                            <a class="online" href="#" data-toggle="tooltip" data-placement="top" title="Dealer" data-original-title="Dealer"><i class="fa fa-suitcase"></i> </a>
                        </div><!-- item-info-right -->
                    </div><!-- ad-meta -->
                </div><!-- item-info -->
            </div><!-- ad-item -->
